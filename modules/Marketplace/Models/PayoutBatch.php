...
use Modules\Marketplace\Enums\PayoutBatchStatus;
 ...
 * @property-read Collection<int, PayoutRequest> $requests
 */
class PayoutBatch extends Model
{
    ...
    {
        return $this->hasMany(PayoutRequest::class, 'payout_batch_id');
    }
}
